      ...
      if (!hasSales) {
        await safeSet(
          ...
          doc(db, "sales", saleId),
          {
            id: saleId,
            userId: uid,
            client: "FORCETY INDUSTRIA E COMERCIO DE ABRASIVOS LTDA.",
            quantity: 12,
            type: "NATAL",
            status: "FATURADO",
            valueProposed: 250,
            ...
            marginPercent: 42.05,
            quoteDate: seedDate,
            completionDate: seedDate,
            date: seedDate,
            isBilled: true,
            hasNF: false,
            observations: "Venda seed (modelo importacao)",
            trackingCode: "255638",
            commissionBaseTotal: 264.6,
            commissionValueTotal: 26.46,
